...
public class OptionsPickerBuilder {
	...
	public OptionsPickerBuilder setTextColorConfirm(int textColor) {
		mPickerOptions.textColorConfirm = textColor;
		return this;
	}

	public OptionsPickerBuilder setTextColorCancel(int textColor) {
		mPickerOptions.textColorCancel = textColor;
		return this;
	}
