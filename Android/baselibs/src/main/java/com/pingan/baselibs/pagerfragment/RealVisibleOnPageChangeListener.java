...
public class RealVisibleOnPageChangeListener implements ViewPager.OnPageChangeListener {
    ...
    public RealVisibleOnPageChangeListener(BaseFragmentPagerAdapter baseFragmentPagerAdapter, int currentPosition) {
        mBaseFragmentPagerAdapter = baseFragmentPagerAdapter;
    ...
    public RealVisibleOnPageChangeListener(BaseFragmentPagerAdapter baseFragmentPagerAdapter, ViewPager.OnPageChangeListener onPageChangeListener, int currentPosition) {
        mBaseFragmentPagerAdapter = baseFragmentPagerAdapter;
        mOnPageChangeListener = onPageChangeListener;
        mCurrentPosition = currentPosition;
    }
